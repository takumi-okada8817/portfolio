...
function modal(){
    $('body').append('<div id="modal-content"><p id="modal-title">Find a small happiness</p><img src="../images/HatchfulExport-All/pinterest_profile_image.png" alt="find a small happiness"><p id="link"><a href="../index.php">ログイン</a></p></div><div id="modal-overlay"></div>');
